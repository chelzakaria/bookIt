<div id="large" class="col-md-3 col-lg-2 col-sm-2 col-2 py-4 pl-4 pr-0" style="min-height:100vh  ;background:#1F1A6B; ">
   <style>
    ...
    <img  id="large_button"  class="d-none d-md-inline mb-4 mt-3"  src="/images/logos/logo_bottom.svg" alt="" style="width:75%; height:auto;">
    <img   class=" d-none  d-sm-block  d-md-none d-block d-sm-none mb-4 mt-1"  src="/images/logos/logo_sidebar.svg" alt="" style="width:37px; height:auto;">
     ...
     <img id="small_button"  class=" mb-4 mt-1"  src="/images/logos/logo_sidebar.svg" alt="" style="width:37px; height:auto; cursor: pointer;">
         ...
         <div class="fixed-bottom mb-3 ml-4" style="width: 20%">
              <form action="{{ route('logout') }}" method="POST" >
                 @csrf
                 <button type="submit" class="btn"  style="font-weight: 400; color:#fff; font-size:14px; text-decoration:none;" >
                      <img class="mr-2 " src="/images/icons/logout_icon.svg" alt="" style="height:auto; width:30px;" > 
                 </button>
             </form>
         </div>
 </div>
