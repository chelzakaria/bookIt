<div class="col-md-3 col-lg-2 col-sm-2 col-2 py-4 pl-4 pr-0" style="min-height: 100vh;background:#1F1A6B; ">
   <style>
    ...
    <img   class="d-none d-md-inline mb-4"  src="/images/logos/logo_bottom.svg" alt="" style="width:75%; height:auto;">
        ...
        <div class="mb-4 hv">
            <a   style="font-weight: 400; color:#fff; font-size:14px; text-decoration:none;" href=""><img class="mr-3 " src="/images/icons/setting_icon.svg" alt="" style="height:auto; width:26px;" > <span class="d-none d-md-inline">Setting</span></a>
        </div>
